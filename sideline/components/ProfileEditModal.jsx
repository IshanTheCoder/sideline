  ...
  const pickImage = async () => {
    try {
      ...
      if (finalStatus !== 'granted') {
        ...
        Alert.alert(
          'Permission Required',
          'Please allow access to your photo library to upload a profile picture. You can enable this in Settings > Sideline > Photos.',
          [
              ...
              onPress: async () => {
                if (Platform.OS === 'ios') {
                  try {
                    ...
                    Alert.alert(
                      'Error',
                      'Could not open settings. Please manually go to Settings > Sideline > Photos to enable photo access.'
                    );
                  }
                }
              },
